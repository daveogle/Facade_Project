...
<div class ="mainContent">
    ...
    <p>This decoupling between client and complex subsystem also helps reduce the number of objects which the client has to interact with helping to adhere to the 'Principle of Least Knowledge' or 'Law of demeter'.
